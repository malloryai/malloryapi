...
class Integrations(SyncResource):
    ...
    def list(
        ...
        **kwargs: Any,
        ...
        return self._list(
            offset=offset, limit=limit, filter=filter, **kwargs
        )
    ...
    def delete(
        self, integration_uuid: str, *, force: bool = False
    ) -> Any:
        params = {"force": force} if force else None
        return self._http.delete(
            f"{self._path}/{integration_uuid}", params=params
        )
    ...
    def run_action(
        ...
        return self._http.post(
            f"{self._path}/{integration_uuid}/actions/{action}",
            json=data,
        )
...
class AsyncIntegrations(AsyncResource):
    ...
    async def capabilities(self) -> Any:
        return await self._http.get(
            f"{self._path}/meta/capabilities"
        )

    async def schemas(self) -> Any:
        return await self._http.get(
            f"{self._path}/meta/schemas"
        )
